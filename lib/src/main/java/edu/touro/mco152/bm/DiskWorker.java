 ...
 */
//implements ProgramUI extends SwingxWorker<Boolean, DiskMark>
...
//             */
//            for (int m = startFileNum; m < startFileNum + App.numOfMarks && !pi.isCancelledpi(); m++) {
//
//                if (App.multiFile) {
...
//                             */
//                            pi.setProgresspi((int) percentComplete);
//                        }
//                    }
...
//        if (App.readTest && App.writeTest && !pi.isCancelledpi()) {
